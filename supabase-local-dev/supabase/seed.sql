...
INSERT INTO "public"."users" ("id", "name", "profile") 
VALUES 
  ('123e4567-e89b-12d3-a456-426614174000', 'test user001', 'hello'),
  ('123e4567-e89b-12d3-a456-426614174001', 'test user002', 'onaka suita'),
  ('123e4567-e89b-12d3-a456-426614174002', 'test user003', 'osushi'),
  ('123e4567-e89b-12d3-a456-426614174003', 'test user004', 'aaaaaaaaaaaaaa');
