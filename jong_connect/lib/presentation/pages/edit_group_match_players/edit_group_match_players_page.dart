...
class EditGroupMatchPlayersPage extends ConsumerStatefulWidget {
  const EditGroupMatchPlayersPage({super.key, required this.groupId});
...
class _EditGroupFormState extends ConsumerState<EditGroupMatchPlayersPage> {
