WITH credentials(id, mail, pass) AS (
  SELECT * FROM (VALUES 
    ...
    ('123e4567-e89b-12d3-a456-426614174006', 'user7@example.com', 'password7')
...
SET
  ...
  "profile" = 'サウナ勢',
  "friend_id" = 7,
  "avatar_url" = 'https://nauixhzrluaiydfkhlch.supabase.co/storage/v1/object/public/avatars/rabbit.png'
where
...
VALUES 
  ...
  (102, 'Mリーグ予選', '勝った人がMリーガー', 'https://nauixhzrluaiydfkhlch.supabase.co/storage/v1/object/public/group_icons/icon_6.png');
...
VALUES 
  ...
  ('123e4567-e89b-12d3-a456-426614174001', 102),
  ('123e4567-e89b-12d3-a456-426614174002', 102),
  ('123e4567-e89b-12d3-a456-426614174005', 102);

INSERT INTO "public"."seasons" ("id", "group_id", "name", "description", "created_at") 
VALUES 
  (101, 101, 'シーズン1', 'シーズンテストです', '2024-08-20 07:02:20.378184+00'),
  (102, 102, 'Mリーグシーズン1', '優勝', '2024-08-20 07:02:20.378184+00');
...
VALUES 
  ...
  (103, 102, 102, 'four', '2024-08-20 07:02:20.378184+00', '123e4567-e89b-12d3-a456-426614174000', '2024-08-20 15:02:20.378184+00'),
  (104, 102, 102, 'four', '2024-08-14 07:02:20.378184+00', '123e4567-e89b-12d3-a456-426614174001', '2024-08-14 20:02:20.378184+00');
...
VALUES 
  ...
  (103, '123e4567-e89b-12d3-a456-426614174000', 'user001', 25000, 3, -10, 1, '2024-08-14 20:02:20.378184+00'),
  (103, '123e4567-e89b-12d3-a456-426614174002', 'user003', 32000, 1, 37, 1, '2024-08-14 20:02:20.378184+00'),
  (103, '123e4567-e89b-12d3-a456-426614174001', 'user002', 27000, 2, 12, 1, '2024-08-14 20:02:20.378184+00'),
  (103, '123e4567-e89b-12d3-a456-426614174005', 'user006', 16000, 4, -39, 1, '2024-08-14 20:02:20.378184+00'),
  (104, '123e4567-e89b-12d3-a456-426614174000', 'user001', 28000, 2, 13, 2, '2024-08-20 16:02:20.378184+00'),
  (104, '123e4567-e89b-12d3-a456-426614174002', 'user003', 22000, 3, -13, 2, '2024-08-20 16:02:20.378184+00'),
  (104, '123e4567-e89b-12d3-a456-426614174001', 'user002', 16000, 4, -39, 2, '2024-08-20 16:02:20.378184+00'),
  (104, '123e4567-e89b-12d3-a456-426614174005', 'user006', 34000, 1, 39, 2, '2024-08-20 16:02:20.378184+00');
