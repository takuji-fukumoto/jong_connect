...
COMMENT ON COLUMN "public"."friends"."friend_id" IS 'フレンドユーザーのfriend_id';
...
COMMENT ON COLUMN "public"."user_friend_requests"."friend_id" IS '申請先ユーザーのフレンドID';
...
ALTER TABLE ONLY "public"."friends"
    ADD CONSTRAINT "friends_friend_id_fkey" FOREIGN KEY ("friend_id") REFERENCES "public"."users"("friend_id");
...
ALTER TABLE ONLY "public"."user_friend_requests"
    ADD CONSTRAINT "user_friend_requests_friend_id_fkey" FOREIGN KEY ("friend_id") REFERENCES "public"."users"("friend_id");
